...
const SocialMediaIcon = ({ Icon, href }) => (
  <a href={href} target="_blank" rel="noopener noreferrer">
    <Icon
      className="w-7 h-7 text-white transition ease-in-out delay-150 hover:scale-125 duration-300"
    />
  </a>
);
      ...
      >
        ...
        <div className="w-full flex flex-col gap-2 rounded-b-[8px] p-1">
          ...
          <div className="flex gap-6 py-2">
            ...
            {name === "Aditya Raj" && (
              <a href="https://www.behance.net/adi_ux" target="_blank" rel="noopener noreferrer">
                <Image
                  src={behanceLogo}
                  className="w-7 h-7"
                  alt="Behance Logo"
